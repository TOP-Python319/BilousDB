...
# всё понятно, но есть небольшие избыточные скобки в условии if
# в конце файла нет пустой строки - это не так важно, но обычно так делают
# в целом все хорошо, вопросов нет. =)