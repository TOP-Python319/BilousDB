...
# Просто проверяем, что после разбиения на '@' и '.' есть как минимум 2 части доменов.
# Если это так, то считаем, что адрес электронной почты корректен.
# Никаких дополнительных проверок не делаем, например, на длину доменных имен.